...
Global Const $EngineSettingsClearHive[110][181] = [ _
	...
	['[Engine.SeqAct_Interp]','RenderingOverrides=(bAllowAmbientOcclusion=False'], _
	...
	['[Engine.Client]','DisplayGamma=2.2','MinDesiredFrameRate=150','InitialButtonRepeatDelay=0.2','ButtonRepeatDelay=0.1'], _
	...
	['[TaskPerfTracking]','bUseTaskPerfTracking=False','RemoteConnectionIP=10.1.10.83','ConnectionString=Provider=sqloledb','RemoteConnectionStringOverride=Data Source=DB-02'], _
	['[FPSChartTracking]','ShouldTrackFPSWhenNonInteractive=False'], _
	['[TaskPerfMemDatabase]','bUseTaskPerfMemDatabase=False','RemoteConnectionIP=10.1.10.83','ConnectionString=Provider=sqloledb','RemoteConnectionStringOverride=Data Source=DEVDB-01'], _
	...
	['[OnlineSubsystemEpic.OnlineSubsystemEpic]','LogLevel=600','ProductId=f71b1231985f48d1af3de723e0a6acdd','SandboxId=076207fa2b5c4803a636af606c3c28b7','DeploymentId=e03ac5a2b3444159b50aded07f1ed69b'], _
	...
	['[IniVersion]','0=1643124601.000000','1=1668527977.000000'] _
]
...
Global Const $SystemSettingsClearHive[35][246] = [ _
	...
	['[SystemSettingsIPhone3GS]','BasedOn=SystemSettingsMobileTextureBias','LensFlares=False','DetailMode=2','MobileEnableMSAA=True','MobileMaxMemory=100','bMobileUsingHighResolutionTiming=False','MobileLandscapeLodBias=2'], _
	...
	['[SystemSettingsIPhone4S]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=True','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.025','MobileContentScaleFactor=2.0','MaxShadowResolution=256','MobileShadowTextureResolution=256'], _
	['[SystemSettingsIPhone5]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=True','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.025','MobileContentScaleFactor=2.0','MaxShadowResolution=256','MobileShadowTextureResolution=1024','AllowRadialBlur=True'], _
	...
	['[SystemSettingsIPodTouch5]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=True','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.025','MobileContentScaleFactor=2.0','MaxShadowResolution=256','MobileShadowTextureResolution=256'], _
	...
	['[SystemSettingsIPad2]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=False','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.016','MobileContentScaleFactor=1.0','MaxShadowResolution=256','MobileShadowTextureResolution=256'], _
	['[SystemSettingsIPad3]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=False','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.016','MobileContentScaleFactor=1.40625','MaxShadowResolution=256','MobileShadowTextureResolution=256','MobileMaxMemory=500'], _
	['[SystemSettingsIPad4]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=False','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.016','MobileContentScaleFactor=2.0','MaxShadowResolution=512','MobileShadowTextureResolution=512','MobileMaxMemory=500','AllowRadialBlur=True'], _
	['[SystemSettingsIPadMini]','BasedOn=SystemSettingsMobile','MobileEnableMSAA=False','bAllowLightShafts=False','MobileModShadows=True','DynamicShadows=False','ShadowDepthBias=0.016','MobileContentScaleFactor=1.0','MaxShadowResolution=256','MobileShadowTextureResolution=256'], _
	...
	['[IniVersion]','0=1555518095.000000','1=1652786458.000000'], _
	['[SettingsCheck]','Initialized=True'] _
]

Global Const $GameSettingsClearHive[52][151] = [ _
	...
	['[IniVersion]','0=1555517716.000000','1=1650365120.000000'], _
